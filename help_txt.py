...
/grep - отдает файл с запросами ip за 10 минут(если использовать после ip аргумент short, то данные в виде ip timestamp url), пример: /grep 1.2.3.4 или /grep 1.2.3.4 short
